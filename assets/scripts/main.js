...
async function getRecipes() {
    ...
    for (const i of RECIPE_URLS) {
        try {
            ...
            fetchRecipesArray.push(fetched);
            //if (fetchRecipesArray.length == RECIPE_URLS.length) {
            // saveRecipesToStorage(fetchRecipesArray);
            // resolve(fetchRecipesArray);
        }
